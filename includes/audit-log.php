<?php
/**
 * لاگ ممیزی رویدادهای امنیتی (نه لاگ عمومی هر API — فقط رویدادهای
 * واقعا حساس: ورود موفق/ناموفق، خروج، تغییر رمز، فعال/غیرفعال‌سازی
 * کاربر). برای گزارش افتا: هر رویداد شامل عامل اقدام، زمان، و IP.
 *
 * این تابع هیچ‌وقت نباید عملیات اصلی رو بشکنه — اگه خود لاگ‌کردن با
