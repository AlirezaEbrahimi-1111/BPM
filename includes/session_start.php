...
if (!headers_sent()) {
    // CSP فقط Report-Only است (چیزی را بلاک نمی‌کند). چون کلِ کدبیس پر از
    // <script>ِ درون‌خطی و style="..."ِ درون‌خطی است، 'unsafe-inline' برای هر دو
    // اضافه شده تا کنسول پر از گزارشِ نقضِ بی‌عمل نشود. یک CSPِ واقعیِ ضدِ XSS
