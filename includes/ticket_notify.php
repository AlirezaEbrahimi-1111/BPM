...
/**
 * کاربران «نظاره‌گر تیکت» — دسترسی خواندن همهٔ تیکت‌ها را دارند، ولی هیچ
 * اعلان / پیامک / بج «توپ در زمین تو» برایشان نمی‌رود، مگر تیکت متعلق به
 * خودشان باشد (سازنده یا متصدی).
 *
 * تفاوتش با getSuperAdminIds(): آن لیست «پشتیبان‌ها»ست که واقعا به تیکت‌ها
