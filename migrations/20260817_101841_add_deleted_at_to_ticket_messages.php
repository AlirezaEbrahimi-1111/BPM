<?php
/**
 * حذف منطقی تک‌تک پیام‌های تیکت (نه کل تیکت — که از قبل با
 * tickets.deleted_at پشتیبانی می‌شد). لازم شد چون یه پاسخ اشتباه از
 * اکانت یه کاربر توی یه تیکت ارسال شده بود.
 */
