<?php
/**
 * افزودنِ سطحِ دسترسیِ ریزتر به بیننده‌هایِ تسک — پیش‌فرض همه‌چیز روشنه
 * (چون معنایِ پایه‌ایِ «بیننده» دیدنِ کامل هست)، ولی موقعِ افزودن می‌شه
 * پیوست‌ها/تاریخچه رو برایِ یک نفرِ خاص خاموش کرد.
 */
