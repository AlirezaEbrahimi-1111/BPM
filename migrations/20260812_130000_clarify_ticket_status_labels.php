<?php
/**
 * برچسبِ وضعیت‌هایِ «باز» و «منتظر پاسخ» گنگ بودن — کاربر نمی‌فهمید نوبتِ
 * کیه. طبقِ منطقِ api/tickets/reply.php (پاسخِ سوپرادمین → waiting_reply،
 * پاسخِ کاربر → open)، این دو تا رو صریح می‌کنیم که الان نوبتِ کیه.
 */
