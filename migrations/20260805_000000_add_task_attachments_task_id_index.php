 ...
 * ───────────────────────────────────────────────────────────────────
 *  چرا؟
 *    بررسیِ کندیِ صفحات «نظارت بر کارها» و «کارهای من» نشان داد که
 *    task_attachments هیچ ایندکسی جز کلید اصلی ندارد. زیرکوئریِ جستجوی
 *    نام فایل‌های پیوستی (`WHERE ta.task_id = t.id`، داخلِ history_text
 *    در TaskManager.php / api/tasks/my-tasks.php / api/tasks/overview.php)
 *    برای هر ردیفِ تسک، یک جستجوی کاملِ روی کل جدول انجام می‌دهد.
 *    با رشدِ تعدادِ پیوست‌ها، این هزینه به‌شدت بالا می‌رود.
 * ═══════════════════════════════════════════════════════════════════
 */
