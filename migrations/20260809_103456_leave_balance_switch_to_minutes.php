<?php
/**
 * اصلاحِ سیستمِ سهمیهٔ مرخصی طبقِ توضیحاتِ دقیق‌ترِ کارفرما:
 *   - واحد از «روز» به «دقیقه» تغییر می‌کنه (برایِ محاسبهٔ دقیق با ساعتِ کاریِ
 *     روزانهٔ هر فرد که ممکنه بینِ پرسنل فرق کنه)
 *   - سهمیهٔ مرخصی و پاس مشترکه — یک استخر، نه دو تایِ جدا — پس یک تایپِ
 *     تراکنشیِ جدید (pass_deduction) و یک ستونِ نوعِ ارجاع لازمه تا هم به
 *     leave_requests و هم به pass_requests اشاره کنه (بدونِ دو ستونِ FK جدا)
 */
