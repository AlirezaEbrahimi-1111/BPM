...
/**
 * ═══════════════════════════════════════════════════════════════════
 *  مهاجرت: افزودن reply_to_message_id به chat_messages — پاسخ به پیام خاص
 *  تاریخ: ۱۴۰۵/۰۵/۱۵
 * ───────────────────────────────────────────────────────────────────
 *  NULL یعنی پیام عادی؛ مقدار داشتن یعنی این پیام پاسخ یک پیام
 *  دیگر است — در حباب، خلاصه‌ی پیام اصلی بالای متن پاسخ نمایش
 *  داده می‌شود (دقیقا مثل تلگرام/واتساپ).
 *
 *  ON DELETE SET NULL: اگر پیام اصلی (که به آن پاسخ داده شده) بعدا
 *  «حذف برای همه» شود، پاسخ باقی می‌ماند ولی دیگر ارجاعی ندارد —
 *  به‌جای شکستن رفرنس یا حذف زنجیره‌ای پاسخ‌ها.
 * ═══════════════════════════════════════════════════════════════════
 */
