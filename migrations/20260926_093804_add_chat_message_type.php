<?php
/**
 * افزودن ستون type به chat_messages — برای پیام‌های سیستمی/رویدادی
 * (مثل «فلان کاربر به گروه اضافه شد») که باید متفاوت از پیام معمولی
 * (بدون حباب چت، بدون آواتار، وسط‌چین) نمایش داده بشن — دقیقا مثل
 * تلگرام/واتساپ.
 */
