...
/**
 * ═══════════════════════════════════════════════════════════════════
 *  مهاجرت: افزودن توضیحات تکمیل مرحله به کارهای روتین
 *  تاریخ: ۱۴۰۵/۰۵/۱۲
 * ───────────────────────────────────────────────────────────────────
 *  چرا؟
 ...
 *    مسئول مرحلهٔ بعد، ایجادکنندهٔ روتین و مدیران قابل مشاهده باشد.
 *
 *    این ستون، توضیحات هر مرحله را کنار completed_by/completed_at
 ...
 *    تاریخچهٔ خود تسک (هم مرحلهٔ فعلی، هم مرحلهٔ بعد) دیده شود.
 * ═══════════════════════════════════════════════════════════════════
 */
