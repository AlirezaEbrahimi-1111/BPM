 ...
 *    action='deadline_extended' ثبت می‌کند. برای نمایش رویدادِ رد
 *    (به‌همراه دلیل، اگر وارد شده) در تاریخچهٔ کار، این مقدار جدید لازم
 *    است. چون پایگاه‌داده STRICT نیست، درج مقدارِ خارج از ENUM بی‌صدا
 *    به رشتهٔ خالی تبدیل می‌شود (نه خطا) — یعنی بدون این مهاجرت،
 *    ردیفِ جدید با action خالی/نادرست ذخیره می‌شد.
 * ═══════════════════════════════════════════════════════════════════
 */
