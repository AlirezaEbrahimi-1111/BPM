 ...
 *  ═══ قوانین طلایی ═══
 *
 *  • هر مهاجرت باید down() داشته باشد که دقیقاً کارِ up() را برگرداند.
 *  • هرگز یک مهاجرتِ اجراشده را ویرایش نکنید. مهاجرت جدید بسازید.
 *  • قبل از اجرا روی سرور زنده، حتماً پشتیبان بگیرید.
...
return [
    ...
    /**
     * بازگرداندن تغییر — دقیقاً عکسِ up()
     */
