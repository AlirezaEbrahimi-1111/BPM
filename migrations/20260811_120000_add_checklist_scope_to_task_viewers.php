<?php
/**
 * افزودنِ سومین سطحِ دسترسیِ ریزتر به بیننده‌هایِ تسک: چک‌لیست — تا الان
 * چک‌لیست همیشه برایِ هر بیننده‌ای قابل‌مشاهده بود (بدونِ هیچ کنترلی)،
 * درست مثلِ پیوست/تاریخچه، پیش‌فرض روشنه.
 */
