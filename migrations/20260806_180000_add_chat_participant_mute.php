...
/**
 * ═══════════════════════════════════════════════════════════════════
 *  مهاجرت: افزودنِ is_muted به chat_participants — بی‌صداکردنِ شخصیِ گفتگو
 *  تاریخ: ۱۴۰۵/۰۵/۱۵
 * ───────────────────────────────────────────────────────────────────
 *  دقیقاً مثلِ is_archived: تنظیمی شخصی و فقط برایِ همین کاربر، بدونِ
 *  اثر روی طرفِ مقابل یا بقیه‌ی اعضایِ گروه.
 * ═══════════════════════════════════════════════════════════════════
 */
