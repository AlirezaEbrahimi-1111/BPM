<?php
/**
 * ردیابی «آخرین‌بار که هر کاربر یک تیکت را دید».
 * برای نمایش بج «پیام دیده‌نشده» کنار تب تیکت‌ها در هدر و روی هر ردیف تیکت:
 * تیکت وقتی «دیده‌نشده» است که پیامی از کس دیگری بعد از last_read_at ثبت شده باشد.
 */
