<?php
/**
 * وقتی یه آیتمِ چک‌لیست به فردی ارجاع می‌شه، اون فرد باید بتونه موقعِ
 * تأییدِ آیتم، یه فایل هم پیوست کنه (مثلاً عکسِ رسیدِ انبار). سیستمِ
 * پیوستِ تسک از قبل آماده‌ست (step_ids برایِ مراحلِ روتین)؛ فقط یه ستونِ
 * مشابه برایِ تگ‌کردنِ پیوست به یه آیتمِ چک‌لیستِ خاص لازمه.
 */
