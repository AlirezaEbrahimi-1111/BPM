<?php
/**
 * ستونِ پیوندِ «پیش‌فاکتور → فاکتور رسمی».
 *
 * وقتی یک پیش‌فاکتور به فاکتور رسمی تبدیل می‌شود، converted_to_id روی خودِ
 * پیش‌فاکتور به شناسه‌ی فاکتورِ رسمیِ تازه اشاره می‌کند. پیش‌فاکتورِ تبدیل‌شده
 * دیگر موجودی رزرو نمی‌کند (مثلِ باطل‌شده) ولی وضعیتش دست‌نخورده می‌ماند.
 */
