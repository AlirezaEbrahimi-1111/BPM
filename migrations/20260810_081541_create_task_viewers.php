<?php
/**
 * اجازهٔ «فقط دیدن جزئیات یک تسک» به چند نفر خاص — تسک‌به‌تسک، بدون
 * نیاز به تعریف کار جدید یا تغییر نقش/مسئولیت. جدول جدا نگه داشته
 * می‌شه تا هیچ تداخلی با زنجیرهٔ دسترسی موجود (سازنده/مسئول/مدیر/...)
