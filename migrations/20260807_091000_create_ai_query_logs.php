...
/**
 * ═══════════════════════════════════════════════════════════════════
 *  مهاجرت: ساختِ جدولِ ai_query_logs
 *  تاریخ: ۱۴۰۵/۰۵/۱۶
 * ───────────────────────────────────────────────────────────────────
 *  طبقِ بندِ ۱۶ سندِ docs/ai-assistant/spec-v1.md — لاگِ کاملِ هر
 *  پرسش: شناسه‌ی کاربر، متنِ سؤال، منابعِ استفاده‌شده، پاسخ، مدت‌زمان،
 *  و وضعیت (شاملِ حالتِ «نیازمندِ روشن‌سازی» طبقِ بندِ ۸).
 * ═══════════════════════════════════════════════════════════════════
 */
