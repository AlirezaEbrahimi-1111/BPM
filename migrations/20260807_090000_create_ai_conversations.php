...
/**
 * ═══════════════════════════════════════════════════════════════════
 *  مهاجرت: ساختِ جداولِ ai_conversations / ai_conversation_messages
 *  تاریخ: ۱۴۰۵/۰۵/۱۶
 * ───────────────────────────────────────────────────────────────────
 *  حافظه‌ی کوتاه‌مدتِ دستیارِ هوش‌مصنوعی (طبقِ بندِ ۱۰ سندِ
 *  docs/ai-assistant/spec-v1.md) — آخرینِ چند پیامِ همین conversation
 *  به‌عنوانِ Context برایِ سؤالاتِ دنباله‌دار استفاده می‌شود؛ بعد از
