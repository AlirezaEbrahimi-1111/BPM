<?php
/**
 * پین‌کردنِ تب/فیلترِ پیش‌فرض و ستاره‌زدنِ کارها در داشبورد باید فقط تا
 * پایانِ همون روز معتبر بمونه — قبلاً این توی localStorage با مقایسه‌ی
 * تاریخِ خودِ سیستمِ کلاینت (new Date()) نگه‌داری می‌شد. کاربرهایی که
 * ساعتِ سیستم‌شون درست تنظیم نیست (دقیقاً همون مشکلی که تویِ تاریخ‌گزین
 * هم دیدیم)، هیچ‌وقت این ریست رو نمی‌بینن. این جدول این سه مقدار رو
 * سمتِ سرور نگه می‌داره؛ تاریخِ معتبربودن هم CURDATE()ِ سروره، نه ساعتِ
 * کلاینت.
 */
