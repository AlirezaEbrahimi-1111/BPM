<?php
/**
 * بجِ «مدیر» به‌عنوانِ یک فلگِ کاملاً مستقل از role/permissions — طبقِ
 * درخواستِ صریح، باید برایِ هر عضوِ گروه (نه فقط مدیرها) قابل‌فعال‌سازی
 * باشه، بدونِ اینکه هیچ اختیارِ واقعی‌ای بده یا بگیره. همین‌جا یه ستونِ
 * جدا داره تا هیچ‌وقت با سیستمِ اختیاراتِ واقعیِ مدیرها قاطی نشه.
 */
