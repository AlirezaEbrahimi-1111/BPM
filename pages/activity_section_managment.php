...
if (!hasPermission($__me, 'manage_activity_sections')) {
...
<head>
    ...
    <style>
        ...
        /* این صفحه توکن‌های محلی خودش رو داره که بدون این بلوک، توی تم
           تاریک هیچ‌وقت عوض نمی‌شدن — چون --bg/--border/--text/--muted فقط
           همین‌جا تعریف شدن و جای دیگه‌ای بازتعریف دارک ندارن.
           ⚠️ --surface عمدا اینجا تکرار نشده: custom.css خودش با همین
           سطح تعیّن (:root[data-theme="dark"]) اونو بازتعریف می‌کنه؛ اگه
           اینجا هم بنویسیم var(--surface)، چون خودارجاعه، طبق اسپک CSS
           نامعتبر محاسبه می‌شه و مقدار رو کلا می‌شکنه */
