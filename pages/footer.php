    ...
    <span class="company">یکتا همراهان ملک</span>
        ...
        <span class="footer-version" style="cursor:help; border-bottom:1px dotted currentColor;"
              ...
              title="<b>تازه‌های این نسخه:</b><br>
                     • رفع مشکل کار نکردن فیلترها و «فقط ماه جاری» در درخواست‌های سازمان<br>
                     • نمایش آخرین درخواست‌های ارسالی در ابتدای لیست<br>
                     • کارت‌های آماری شخصی حالا در هر سه زبانه (ورود/خروج، درخواست‌ها، تأییدها) ثابت و همیشه در دسترسند<br>
                     • مشخص‌شدن روز جاری با رنگ متفاوت در جدول ورود و خروج<br>
                     • رفع گیرکردن دکمه‌ی ارسال درخواست بعد از خطای اعتبارسنجی فرم<br>
                     • محدودشدن اولویت «بحرانی» تیکت‌ها فقط به مدیران<br>
                     • ارسال خودکار پیامک به پشتیبانی هنگام ثبت تیکت جدید<br>
                     • رفع باگ دکمه‌ی «تکمیل کار» در داشبورد">
            نسخه: ۴.۲
        </span>
</div>
<script>
