...
<style>
    ...
    #hdrPanelMenu .ann-dropdown-footer a {
        display: block;
        padding: 9px 14px;
    ...
    .navbar-nav.me-0 .settings-btn>i {
        line-height: 1;
                        ...
                        <ul class="dropdown-menu dropdown-menu-end admin-submenu" aria-labelledby="salesInvoiceDropdown">
                            <li>
                                <a class="dropdown-item" href="/pages/inv-invoices.php">
                                    <i class="bi bi-receipt ms-2"></i>فاکتورهای فروش
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a class="dropdown-item" href="/pages/crm-products.php">
                                    <i class="bi bi-box-seam ms-2"></i>کالاها
                                </a>
                            </li>
                            <li>
...
<script>
    ...
    function openAnnouncementModal(ann) {
        ...
        overlay.innerHTML =
            ...
            '<a href="/pages/announcements.php" style="color:#8e57fe;font-weight:700;text-decoration:none;font-size:13px;">مشاهده همه اطلاعیه‌ها <i class="bi bi-chevron-left"></i></a>' +
            '</div>' +
            '</div>';
