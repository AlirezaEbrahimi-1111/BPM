...
// اطلاعیه‌ها برایِ همهٔ کاربرانِ فعال قابلِ‌مشاهده‌ست؛ دکمهٔ «اطلاعیهٔ جدید»
// خودش سمتِ کلاینت بر اساسِ نقش نمایش/مخفی می‌شه و ساختِ اطلاعیه توسطِ API
// جداگانه (send_org_announcement/send_section_announcement) کنترل می‌شه
...
<body>
    ...
    .ann-scope-badge { font-size: .72rem; font-weight: var(--badge-font-weight); padding: 7px 10px; border-radius: var(--badge-radius); background: rgba(142, 87, 254, 0.12); color: #8e57fe; }
