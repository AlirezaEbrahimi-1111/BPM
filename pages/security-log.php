...
<head>
  ...
  <style>
    ...
    .pill { display: inline-flex; align-items: center; gap: 4px; padding: 3px 10px; border-radius: var(--badge-radius); font-size: 11.5px; font-weight: 700; white-space: nowrap; }
