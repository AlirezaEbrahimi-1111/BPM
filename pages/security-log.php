...
<head>
  ...
  <style>
    ...
    .pill { display: inline-flex; align-items: center; gap: 4px; padding: 7px 10px; border-radius: var(--badge-radius); font-size: 11.5px; font-weight: var(--badge-font-weight); white-space: nowrap; }
