...
class DailyMaintenance {
    ...
    public function run() {
        ...
        try {
            ...
            // 6. پاکسازی تنظیمات روزانه‌ی داشبورد (ستاره/پین) که دیگه امروز نیستن
    ...
    /**
     * پاکسازی تنظیمات روزانه‌ی داشبورد (ستاره‌ها + تب/فیلتر پیش‌فرض) —
     * خود bootstrap.php هم با شرط pref_date=CURDATE() این ردیف‌های
     * قدیمی رو نادیده می‌گیره (پس درستی منطق به این cron وابسته نیست)،
     * این فقط برای جلوگیری از تجمع بی‌نهایت ردیف‌های کهنه در جدوله
     */
