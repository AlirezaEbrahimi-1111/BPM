<?php
/**
 * API: فهرست درخواست‌های سهمیهٔ تشویقی برای سرپرست سازمان — فقط
 * درخواست‌های در‌انتظار (pending) رو نشون می‌ده تا فراموش نشن؛ نتیجهٔ
 * غیرپندینگ نیازی به نمایش همیشگی نداره چون خود کارمند نوتیفیکیشن
 * نتیجه رو می‌گیره.
 * GET
 */
