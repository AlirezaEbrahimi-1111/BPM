<?php
/**
 * API: موجودیِ فعلیِ سهمیهٔ مرخصیِ استحقاقی + تاریخچه
 * GET ?user_id=123  (اگه ندید، خودِ کاربرِ درخواست‌دهنده)
 *
 * دسترسی: خودِ کاربر، یا مدیر/سرپرستی که canManageTargetUser بهش اجازه بده
 */
