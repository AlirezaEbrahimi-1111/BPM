<?php
/**
 * API: بی‌صدا/باصدا کردن شخصی یک گفتگو (تاگل)
 * POST /api/chat/toggle-mute.php   body: { conversation_id: 1 }
 *
 * دقیقا مثل بایگانی: تنظیمی شخصی، فقط برای همین کاربر، بدون نیاز به
 * دسترسی مدیریتی حتی در گروه — چون هیچ اثری روی بقیه ندارد.
 */
