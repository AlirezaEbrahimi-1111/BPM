<?php
/**
 * API: وضعیت «خوانده‌شدن» پیام‌ها — آخرین پیام‌خوانده‌شده‌ی بقیه‌ی شرکت‌کننده‌ها
 * GET /api/chat/read-receipts.php?conversation_id=1
 *
 * توجه: last_read_message_id خود کاربرها توسط messages.php هر بار که پیام‌ها را
 * می‌خوانند به‌روز می‌شود — این اندپوینت فقط همان مقدار را برای «دیگران» برمی‌گرداند.
 */
