<?php
/**
 * API: حذف کامل یک گفتگوی مستقیم — فقط از دید خود کاربر درخواست‌دهنده.
 * طرف مقابل هیچ اثری نمی‌بیند و پیام‌ها واقعا حذف نمی‌شن (فقط با همون
 * مکانیزم chat_message_hidden که delete-message.php هم استفاده می‌کنه،
 * از دید همین کاربر پنهان می‌شن) — پس اگه بعدا پیام جدیدی رد و بدل بشه،
 * گفتگو دوباره توی لیست ظاهر می‌شه.
 *
 * فقط برای گفتگوهای type='direct' — برای گروه معادلش leave-group.php ست.
 *
