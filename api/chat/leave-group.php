<?php
/**
 * API: خروج کاربر جاری از یک گروه (شامل خود سازنده)
 * POST /api/chat/leave-group.php   body: { conversation_id: 1 }
 *
 * توجه: اگر سازنده خارج شود، گروه بدون مدیر باقی می‌ماند (افزودن/حذف عضو
 * دیگر ممکن نیست) — تصمیم عامدانه برای سادگی فاز اول، بدون انتقال مالکیت.
 */
...
try {
    ...
    if ($remaining === 0) {
        // گروه بدون‌عضو دیگر فایده‌ای ندارد — کاملا حذف می‌شود (پیام/پیوست‌ها هم با CASCADE پاک می‌شوند)
