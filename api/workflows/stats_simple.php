...
// ⚠️ این فایل ظاهرا بازماندهٔ نسخهٔ قدیمی اسکیما است (جدول workflows جای دیگری
...
// این فایل هیچ‌جا از رابط کاربری فراخوانی نمی‌شود. صرفا برای بستن نشت
// بدون‌احرازهویت آمار کل پلتفرم، احراز هویت اضافه شد؛ اگر واقعا غیرفعال
