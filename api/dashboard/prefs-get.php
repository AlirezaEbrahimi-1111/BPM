 ...
 *  خواندنِ تنظیماتِ روزانه‌ی داشبورد (کارهایِ ستاره‌دار، تبِ پیش‌فرض،
 *  فیلترِ پیش‌فرض) — همان کوئریِ api/dashboard/bootstrap.php، جدا شده
 *  تا صفحاتی مثلِ task-detail.php هم بتوانند بدونِ بارگذاریِ کلِ
 *  باندلِ داشبورد، فقط همین را بخوانند.
 * ═══════════════════════════════════════════════════════════════════
 */
