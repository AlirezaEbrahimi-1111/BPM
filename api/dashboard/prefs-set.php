 ...
 *  ذخیره‌ی یکی از سه‌تا تنظیم روزانه‌ی داشبورد (کارهای ستاره‌دار، تب
 *  پیش‌فرض، فیلتر پیش‌فرض) — سمت سرور، با تاریخ سرور (نه کلاینت).
 * ═══════════════════════════════════════════════════════════════════
 */
...
try {
    ...
    // مقدار همیشه به‌صورت رشته ذخیره می‌شه (starred_tasks خودش JSON رشته‌شده می‌فرسته)
