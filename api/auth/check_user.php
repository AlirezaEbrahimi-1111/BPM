...
try {
    ...
    // 🔒 قبلا این endpoint بدون هیچ محدودیتی بود — یعنی می‌شد با امتحان‌کردن
    // پی‌درپی شماره‌موبایل‌ها، فهرست کاربران ثبت‌شده رو استخراج کرد
    // (user enumeration). حداکثر ۲۰ درخواست در ۱۵ دقیقه به‌ازای هر IP
