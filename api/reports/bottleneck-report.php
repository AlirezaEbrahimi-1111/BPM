...
try {
    ...
    /* ═══════════════════════════════════════════════════
       کوئری اصلی — مراحل فعال از موعد گذشته
       ═══════════════════════════════════════════════════ */
    $sql = "
        SELECT
            ws.step_name,
        ...
        WHERE wi.organization_id = ?
          ...
          -- 🔒 کرون (checkDelays در WorkflowManager.php) به‌محض گذشتن ددلاین،
          -- وضعیت مرحله رو دائمی از 'active' به 'delayed' تغییر می‌ده — توی
          -- دیتابیس واقعی تقریبا همه‌ی مراحل تأخیردار همین الان 'delayed'ان،
          -- نه 'active' (۲۴ به ۱). قبلا این کوئری فقط 'active' رو می‌دید، یعنی
          -- تقریبا هیچ‌کدوم از گلوگاه‌های واقعی رو نشون نمی‌داد
