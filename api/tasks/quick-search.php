...
/**
 * quick-search.php
 * جستجوی سبک بین تسک‌های قابل‌دسترس کاربر فعلی — سازنده/مسئول فعلی، یا هر
 * کسی که طبق task_history حداقل یک‌بار در این کار مشارکت داشته (مثلا قبلا
 * مسئولش بوده و بعدا ارجاع/تکمیل/تأیید شده) — دقیقا همون قاعده‌ای که
 * api/tasks/detail.php برای دسترسی مشاهده استفاده می‌کنه، تا کاربر بتونه
 * کارهایی که در گذشته روش کار کرده رو هم پیدا کنه، نه فقط کارهای فعلا بازش.
 * برای استفاده در پیوست یک تسک به تیکت پشتیبانی (create-ticket.php) و
 * پیوند کار در چت (#... در chat.php).
 * برخلاف جستجوی صفحات کارها، اینجا فقط شناسه/عنوان لازم است — سبک و سریع.
 */
