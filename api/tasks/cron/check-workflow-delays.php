<?php
// جلوگیری از دسترسی مستقیم از مرورگر — هم‌راستا با بقیهٔ اسکریپت‌هایِ کرون
// (مثلِ cron/auto_approval_check.php)؛ قبلاً این چک اینجا نبود و هر کسی
// می‌تونست این اسکریپت رو از وب صدا بزنه
if (php_sapi_name() !== 'cli') {
    die('This script can only be run from command line.');
}

// نکته: مسیرهایِ نسبیِ قبلی («../») فقط یک سطح بالا می‌رفتن (تا api/tasks/)
// نه تا ریشهٔ سایت، پس این require_once ها همیشه با «failed to open stream»
// فیل می‌شدن و این اسکریپت هیچ‌وقت واقعاً اجرا نمی‌شد
