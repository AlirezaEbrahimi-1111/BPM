 ...
 * ارسالِ آزمایشیِ پیامک به یک شماره‌ی دلخواه — بدونِ تأثیر روی چرخش/تاریخِ
 * آخرین ارسالِ خودکار (فقط برای تستِ فرمتِ پیام)
 *
 *   POST /api/admin/hekmat-test-send.php
 *   body: {phone, text?}   — text اختیاریه؛ اگه نباشه، پیش‌نمایشِ امروز فرستاده می‌شه
 */
