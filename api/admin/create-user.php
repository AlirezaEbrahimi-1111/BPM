...
try {
    ...
    if ($current_org_id) {
        // 🔒 قفلِ هم‌زمانی برای این سازمان: بدونِ آن، دو درخواستِ «افزودن
        // کاربر»ِ هم‌زمان هر دو COUNT را زیرِ سقف می‌بینند و هر دو کاربر
        // ساخته می‌شود (عبور از سقفِ اشتراک). قفل با پایانِ درخواست آزاد می‌شود.
