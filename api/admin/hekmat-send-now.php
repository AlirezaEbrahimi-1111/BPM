 ...
 * ارسال دستی فوری حکمت بعدی به همه‌ی گیرنده‌های فعال — همون منطق
 * cron (runDailySend)، صرفا با کلیک دستی. چرخش و last_sent_date رو
 * دقیقا مثل ارسال خودکار آپدیت می‌کنه (پس اگه cron هم امروز اجرا بشه،
 * دوباره نمی‌فرسته).
 *
